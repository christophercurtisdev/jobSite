        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_job_categories.labels.management') }} <small class="text-muted">{{ __('backend_job_categories.labels.deleted') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_job_categories.table.deleted')</th>
                        ...
                        @foreach($jobCategories as $jobCategory)
                            <tr>
                                ...
                                <td class="align-middle">{{ $jobCategory->deleted_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $jobCategory->trashed_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
