        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_job_types.labels.management') }} <small class="text-muted">{{ __('backend_job_types.labels.active') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_job_types.table.last_updated')</th>
                            <th>@lang('backend_job_types.table.actions')</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($jobTypes as $jobType)
                            <tr>
                                ...
                                <td class="align-middle">{{ $jobType->updated_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $jobType->action_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
