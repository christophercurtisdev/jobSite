        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_skills.labels.management') }} <small class="text-muted">{{ __('backend_skills.labels.active') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_skills.table.last_updated')</th>
                            <th>@lang('backend_skills.table.actions')</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($skills as $skill)
                            <tr>
                                ...
                                <td class="align-middle">{{ $skill->updated_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $skill->action_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
