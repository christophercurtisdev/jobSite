        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_organisations.labels.management') }} <small class="text-muted">{{ __('backend_organisations.labels.active') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_organisations.table.last_updated')</th>
                            <th>@lang('backend_organisations.table.actions')</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach($organisations as $organisation)
                            <tr>
                                ...
                                <td class="align-middle">{{ $organisation->updated_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $organisation->action_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
