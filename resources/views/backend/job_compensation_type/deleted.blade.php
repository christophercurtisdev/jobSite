        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('backend_job_compensation_types.labels.management') }} <small class="text-muted">{{ __('backend_job_compensation_types.labels.deleted') }}</small>
                </h4>
            </div><!--col-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th>@lang('backend_job_compensation_types.table.deleted')</th>
                        ...
                        @foreach($jobCompensationTypes as $jobCompensationType)
                            <tr>
                                ...
                                <td class="align-middle">{{ $jobCompensationType->deleted_at->diffForHumans() }}</td>
                                <td class="align-middle">{!! $jobCompensationType->trashed_buttons !!}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
